...
public class Assembler {
	...
	private int proccessMove(String[] tokens) {
		...
		if ((p1.startsWith("%"))&&(p2.startsWith("&"))) { //this is a moveRegMem comand
			p = commands.indexOf("moveRegMem");
		}
		if ((!p1.startsWith("%"))&&(p2.startsWith("%"))&&(!p2.startsWith("&"))) { //this is a moveImmReg comand
	...
	private int proccessAdd(String[] tokens) {
		...
		if ((p1.startsWith("&"))&&(p2.startsWith("%"))) { //this is a addMemReg comand
			p = commands.indexOf("addMemReg");
		}
		if ((p1.startsWith("%"))&&(p2.startsWith("&"))) { //this is a addRegMem comand
			p = commands.indexOf("addRegMem");
		}
		if ((!p1.startsWith("%"))&&(p2.startsWith("%"))&&(!p2.startsWith("&"))) { //this is a addImmReg comand
	...
	private int proccessSub(String[] tokens) {
		...
		if ((p1.startsWith("&"))&&(p2.startsWith("%"))) { //this is a subMemReg comand
			p = commands.indexOf("subMemReg");
		}
		if ((p1.startsWith("%"))&&(p2.startsWith("&"))) { //this is a subRegMem comand
			p = commands.indexOf("subRegMem");
		}
		if ((!p1.startsWith("%"))&&(p2.startsWith("%"))&&(!p2.startsWith("&"))) { //this is a subImmReg comand
	...
	private int proccessImul(String[] tokens) {
		...
		if ((p1.startsWith("&"))&&(p2.startsWith("%"))) { //this is a imulMemReg comand
			p = commands.indexOf("ImulMemReg");
		}
		if ((p1.startsWith("%"))&&(p2.startsWith("&"))) { //this is a imulRegMem comand
